    ...
    <div className="h-full w-full">
        ...
        <div className=' flex flex-col absolute top-[20%] left-[20%] md:left-[10%] lg:left-[5%]  w-[50%] h-[40%] md:h-[50%] lg:h-[70%]'>
            ...
            <div className='w-[100%] flex justify-start p  '>
              <button className=" p-3 px-6 md:px-10  gabarito text-[16px] md:text-[20px] lg:text-[30px]   ml-[9%] border-[#F7F6BB] border-2  rounded-full text-[#F7F6BB] flex items-center gap-2 justify-center">Taste Now <img src={Arrow} alt="" /></button>
            </div> 
        </div>
