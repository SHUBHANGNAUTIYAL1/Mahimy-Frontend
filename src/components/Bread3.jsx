...
function Bread3() {
  return (
    <div className='w-full py-20 bg-[#A4CF25]  flex items-center justify-center'>
      <div className='w-[90%] flex flex-col md:flex-row  items-center gap-16 justify-center '>  
        <div className=' w-[44%] flex flex-col gap-12 md:order-1 order-2'>
